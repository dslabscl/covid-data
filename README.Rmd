...
Ejemplo de uso de datos de COVID recopilados por el Ministerio de Ciencia de Chile https://www.minciencia.gob.cl/covid19. Última actualización: `r Sys.Date()`
...
ggplot(
  ...
  labs(title = "Casos nuevos totales Metropolitana\n(últimos 7 días)", caption = "Fuente: https://www.minciencia.gob.cl/covid19")
```
